...
public sealed class CabinStateRowViewModel : BaseViewModel
{
    ...
    private string _mechanicalHealthDisplay = string.Empty;
    private string _electricalHealthDisplay = string.Empty;
    private string _brakeHealthDisplay = string.Empty;
    ...
    public string MechanicalHealthDisplay { get => _mechanicalHealthDisplay; private set => SetProperty(ref _mechanicalHealthDisplay, value); }

    public string ElectricalHealthDisplay { get => _electricalHealthDisplay; private set => SetProperty(ref _electricalHealthDisplay, value); }

    public string BrakeHealthDisplay { get => _brakeHealthDisplay; private set => SetProperty(ref _brakeHealthDisplay, value); }
    ...
    public void UpdateFrom(CabinSnapshot snapshot)
    {
        ...
        MechanicalHealthDisplay = $"{snapshot.MechanicalHealthPercent:F0}%";
        ElectricalHealthDisplay = $"{snapshot.ElectricalHealthPercent:F0}%";
        BrakeHealthDisplay = $"{snapshot.BrakeHealthPercent:F0}%";
